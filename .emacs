...
(custom-set-variables
 ...
 '(package-selected-packages
   '(avy claude-code company dap-mode flycheck go-mode helm-lsp helm-xref
	 hydra lsp-mode lsp-treemacs lsp-ui magit projectile which-key
	 yasnippet)))
(custom-set-faces
...
(set-face-attribute 'default nil
  :family "Consolas"
  :height 100)   ; height is in 1/10 pt, so 120 = 12pt
